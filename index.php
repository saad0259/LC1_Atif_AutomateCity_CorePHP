...
<section class="hero-slider style1">
							...
							<div class="col-lg-7 col-md-8 col-12">
								<div class="welcome-text"> 
									<div class="hero-text"> 
										...
										<h1>Strategic Concepts for Evolving Businesses</h1>
										<div class="p-text">
					...
					<div class="col-12">
						<div class="blog-latest blog-latest-slider" >
							<div class="single-slider " >
								<!-- Single Blog -->
								<div class="single-news" style="height:450px">
									<div class="news-head overlay">
										<span class="news-img" style="background-image:url('https://theleagueofecom.com/wp-content/uploads/2021/01/rsw_1300h_8002.jpg');background-size:contain;"></span>
				...
				<div class="row">
					<div class="col-lg-9 col-12">
						<div class="call-inner">
							<h2>Contact Us on WhatsApp <i class="fa fa-whatsapp"></i></h2>
							<p></p>
						</div>
					</div>
		...
		<section class="services section-bg section-space">
			<div class="section-top text-center">
				<h1>See What is best for you</h1>
			</div>
			<div class="container">
				<div class="row">
					<div class="col-12">
